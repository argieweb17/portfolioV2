    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl shadow-md shadow-blue-900 border border-blue-800  bg-transparent backdrop-blur-md  transition duration-700 overflow-hidden"
        >
